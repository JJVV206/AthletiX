  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ring-offset-background",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 border border-white/60",
        ghost: "hover:bg-secondary/70 text-foreground",
        outline:
          "border border-primary/20 bg-white/70 text-primary hover:border-primary/40 hover:bg-white",
        lime: "bg-lime text-accent-foreground shadow-glow hover:brightness-105",
      },
      size: {
